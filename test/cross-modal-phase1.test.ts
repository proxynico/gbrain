...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 19 (cross-modal still appended; 15→16 detail fold #3515; 16→17 degradation-stamp epoch; 17→18 preferred-type recall; 18→19 preferred-type coverage)', () => {
    ...
    // 18→19: one selected page per preferred type receives bounded coverage
